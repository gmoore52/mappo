...
from .starcraft2_multiplayer import StarCraft2Env
...
class StarCraftCapabilityEnvWrapper(MultiAgentEnv):
    ...
    def get_state(self, a_id):
        return self.env.get_state(a_id)
    ...
    def get_obs_enemy(self, enemy_id):
        return self.env.get_obs_enemy(enemy_id)

    def get_avail_agent_actions(self, agent_id):
        return self.env.get_avail_agent_actions(agent_id)
    
    def get_avail_enemy_actions(self, enemy_id):
        return self.env.get_avail_enemy_actions(enemy_id)

    def render(self):
        return self.env.render()

    def step(self, rightActions, leftActions):
        return self.env.step(rightActions, leftActions)
